...
class EndScene extends BaseLevelScene {
    ...
    preload() {
        ...
        let middleImage = 'assets/images/best.png';
        if (this.remainingLives < 0) {
            middleImage = 'assets/images/best.png';
        }

        this.load.image('background', 'assets/images/best.png');
        this.load.image('middle', middleImage);
        this.load.image('button', 'assets/images/playagain.png');

        this.load.audio('cat_purr', 'assets/sounds/cat_purr.ogg');
    }
