...
class BaseLevelScene extends Phaser.Scene {
    ...
    preload() {
        this.load.audio("falling", "assets/sounds/falling2_sfx_sounds_falling4.wav");
        this.load.audio('angry_cat', 'assets/sounds/cat_angry.ogg');

        this.load.image('touch_arrow', 'assets/images/touch_arrow_right.png');
        this.load.image('cat_lives', 'assets/images/heart.png');
