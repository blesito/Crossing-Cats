...
class StreetLevel extends BaseLevelScene {
    ...
    preload() {
        ...
        this.load.image('bg', 'assets/maps/street/street_background.png');
        this.load.image('car', 'assets/images/jeep.png');
        this.load.spritesheet('animcat', 'assets/images/cat_walking_animated.png', {frameWidth: 97, frameHeight: 101});
        this.load.image('goal', 'assets/images/tree.png');
        this.load.image('house', 'assets/maps/street/haws.png');
        ...
        this.load.audio('backgroundmusicstreet', 'assets/sounds/Big_Rock.ogg');
        this.load.audio('backgroundmusicstreetcape', 'assets/sounds/Pixel_Peeker_Polka.ogg');
        this.load.audio('cat_hit', 'assets/sounds/cat_angry.ogg');
        this.load.audio('meow', 'assets/sounds/cat_meow1.ogg');
    }
